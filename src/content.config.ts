 ...
 * The `id` generated by the glob loader is the path relative to base INCLUDING
 * the extension, e.g. "en/bosses/emberfang.mdx" — strip ".mdx" before using it
 * as a URL/lookup key (parseEntryId in src/lib/content-utils.ts does this;
 * note getEntry() wants the id WITHOUT the extension).
 *
